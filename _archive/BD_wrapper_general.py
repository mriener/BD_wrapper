...
class BayesianDistance(object):
    ...
    def extract_probability_info(self, line):
        """
    ...
    def extract_results(self, result_file_content):
        """
        ...
        for line in result_file_content:
            ...
            if searchString in line:
                results.append(self.extract_probability_info(line))
        return results
    ...
    def get_results(self, source):
        ...
        results = self.extract_results(result_file_content)
        return results
    ...
    def batch_calculation(self):
        ...
        import BD_multiprocessing_general
        BD_multiprocessing_general.init([self, self.inputTable])
        results_list = BD_multiprocessing_general.func()
        print('SUCCESS\n')
